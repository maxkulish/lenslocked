...
// This uses the crypto/rand package so it is safe
// to user with things like remember tokens
...
// then return a string that is the base64 URL encoded varsion
// of that byte slice
...
// remember token of a predetermined byte size
